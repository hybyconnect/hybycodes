  ...
  return (
    ...
    <div className="bg-gradient-to-r from-[#ffad33] via-[#ffd633] to-[#ffb84d] min-h-screen p-8 md:p-16 text-black">
      ...
      <nav className="text-sm text-gray-600">
        Home &gt; Projects &gt; <span className="text-green-600 font-semibold">Neon Personal Portfolio | HTML, CSS, JS</span>
      </nav>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-yellow-200 p-4 rounded-lg">
          <img src={assets.port} alt="Neon Portfolio" className="w-full rounded" />
        ...
        <div>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <span className="bg-purple-500 text-white text-xs px-2 py-1 rounded">Bootstrap</span>
          </div>
